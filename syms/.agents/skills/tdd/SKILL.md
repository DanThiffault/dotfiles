...
- **Implementation-coupled**: mocks internal collaborators, tests private methods/functions, or verifies through a side channel (querying the database instead of using the interface). The tell: the test breaks when you refactor but behavior hasn't changed.
